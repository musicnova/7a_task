...
{{ params.home }}/dags/pyspark/prod_data/calc_06.py {{ params.srv_list }} {{ params.queue_name }} {{ params.partitions }} {{ params.loaddttm }}
"""

algo_bash_load = BashOperator(
    task_id='prod_data_algo_calc_06',
